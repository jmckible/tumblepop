...
ActiveRecord::Schema.define(:version => 20101011053422) do
  ...
  add_index "days", ["question_id"], :name => "index_days_on_question_id"
  ...
  add_index "reads", ["reader_id", "writer_id"], :name => "index_reads_on_reader_id_and_writer_id"
  add_index "reads", ["reader_id"], :name => "index_reads_on_reader_id"
  add_index "reads", ["writer_id"], :name => "index_reads_on_writer_id"
